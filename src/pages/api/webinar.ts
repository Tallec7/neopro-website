...
const buildIcs = (attendeeName: string, attendeeEmail: string) => [
  'BEGIN:VCALENDAR',
  'VERSION:2.0',
  'PRODID:-//MADXP//Webinar//FR',
  'CALSCALE:GREGORIAN',
  'METHOD:REQUEST',
  'BEGIN:VEVENT',
  'UID:webinar-madxp-20260416@kalonpartners.bzh',
  'DTSTAMP:20260408T000000Z',
  'DTSTART:20260416T090000Z',
  'DTEND:20260416T094500Z',
  'SUMMARY:Webinar MADXP : Et si votre gymnase rapportait à votre club ?',
  `DESCRIPTION:Rejoindre le webinar : ${MEET_LINK}`,
  `LOCATION:${MEET_LINK}`,
  'ORGANIZER;CN=MADXP:mailto:contact@kalonpartners.bzh',
...
export const POST: APIRoute = async ({ request }) => {
  ...
  const [emailResult] = await Promise.allSettled([
    resend.emails.send({
      from: 'Gwenvael — MADXP <contact@kalonpartners.bzh>',
      to: email,
      replyTo: 'contact@kalonpartners.bzh',
      subject: 'Votre inscription au webinar du 16 avril',
      headers: {
        'List-Unsubscribe': '<mailto:contact@kalonpartners.bzh?subject=unsubscribe>',
        'List-Unsubscribe-Post': 'List-Unsubscribe=One-Click',
      },
      text: `Bonjour ${prenom},

Votre inscription au webinar MADXP est bien enregistrée.
...
Pour vous désinscrire, répondez à cet email avec "unsubscribe" en objet.`,
      attachments: [
        {
          filename: 'webinar-madxp-16-avril.ics',
...
<body style="margin:0;padding:0;background:#e4edf4;font-family:Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#e4edf4;padding:32px 16px;">
    <tr><td align="center">
      <table width="100%" style="max-width:600px;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">

        <!-- Header -->
        <tr>
          <td style="background:#0a0b0d;padding:32px 40px;text-align:center;">
            <p style="margin:0;color:#0e578e;font-size:28px;font-weight:900;letter-spacing:-0.5px;">MADXP.</p>
          </td>
        </tr>

        <!-- Confirmation badge -->
        <tr>
          <td style="background:#06263f;padding:32px 40px;text-align:center;border-bottom:1px solid rgba(255,255,255,0.08);">
            <div style="display:inline-block;background:rgba(14,87,142,0.15);border-radius:50%;width:64px;height:64px;line-height:64px;font-size:28px;margin-bottom:20px;">✅</div>
        ...
        <!-- Meet link -->
        <tr>
          <td style="background:#06263f;padding:0 40px 32px;text-align:center;">
            ...
            <a href="${MEET_LINK}" style="display:inline-block;background:#0e578e;color:#0a0b0d;font-weight:900;font-size:18px;padding:16px 32px;border-radius:50px;text-decoration:none;">
        ...
        <tr>
          <td style="background:#ffffff;padding:32px 40px;">
            <h2 style="margin:0 0 20px;color:#0a0b0d;font-size:18px;font-weight:900;">Infos pratiques</h2>
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #f0f0f0;color:#6b7280;width:120px;vertical-align:top;">📅 Date</td>
                <td style="padding:10px 0;border-bottom:1px solid #f0f0f0;color:#0a0b0d;font-weight:bold;">Jeudi 16 avril 2026</td>
              </tr>
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #f0f0f0;color:#6b7280;vertical-align:top;">🕙 Heure</td>
                <td style="padding:10px 0;border-bottom:1px solid #f0f0f0;color:#0a0b0d;font-weight:bold;">11h00 – 11h45</td>
              </tr>
              <tr>
                <td style="padding:10px 0;color:#6b7280;vertical-align:top;">💻 Format</td>
                <td style="padding:10px 0;color:#0a0b0d;font-weight:bold;">En ligne — Google Meet</td>
              </tr>
            </table>

            <div style="margin-top:24px;background:#f8faf8;border-left:4px solid #0e578e;border-radius:4px;padding:16px 20px;">
        ...
        <!-- Footer -->
        <tr>
          <td style="background:#e4edf4;padding:24px 40px;text-align:center;">
            <p style="margin:0;color:#9ca3af;font-size:12px;">
              MADXP — La régie des clubs sportifs<br>
              <a href="https://madxp.kalonpartners.bzh" style="color:#093a60;text-decoration:none;">madxp.kalonpartners.bzh</a>
            </p>
          </td>
        </tr>
