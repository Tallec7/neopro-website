...
const routeMap: Record<string, Record<Locale, string>> = {
  ...
  'om-os': aboutRoute,
  'chi-siamo': aboutRoute,
  'o-nas': aboutRoute,
  'over-ons': aboutRoute,
  'sobre-nos': aboutRoute,
  // Advertisers
  ...
  'inserzionisti': annonceurRoute,
  'reklamodawcy': annonceurRoute,
  'adverteerders': annonceurRoute,
  // Offers
  'offres': offresRoute,
  'pricing': offresRoute,
  'precios': offresRoute,
  ...
  'angebot': devisRoute,
  'tilbud': devisRoute,
  'preventivo': devisRoute,
  'wycena': devisRoute,
  'offerte-aanvragen': devisRoute,
  'orcamento': devisRoute,
  // Régie sport
  ...
  'regia-sportiva': regieRoute,
  'rezyseria-sportowa': regieRoute,
  'sportregie': regieRoute,
  'regia-esportiva': regieRoute,
  // Solution
  ...
  // Sport pages — IT slugs
  'pallacanestro': basketballRoute,
  'pallamano': handballRoute,
  'pallavolo': volleyballRoute,
  'calcio-a-5': futsalRoute,
  'calcio': footballRoute,
  'hockey-ghiaccio': hockeyGlaceRoute,
  'hockey-pista': rinkHockeyRoute,
  'hockey-prato': hockeyGazonRoute,
  // Sport pages — NL slugs
  'basketbal': basketballRoute,
  'handbal': handballRoute,
  'volleybal': volleyballRoute,
  'zaalvoetbal': futsalRoute,
  'voetbal': footballRoute,
  'ijshockey': hockeyGlaceRoute,
  'rolhockey': rinkHockeyRoute,
  'veldhockey': hockeyGazonRoute,
  // Sport pages — PL slugs
  'koszykowka': basketballRoute,
  'pilka-reczna': handballRoute,
  'siatkowka': volleyballRoute,
  'pilka-nozna': footballRoute,
  'hokej-na-lodzie': hockeyGlaceRoute,
  'hokej-na-rolkach': rinkHockeyRoute,
  'hokej-na-trawie': hockeyGazonRoute,
  // Sport pages — PT slugs
  'basquetebol': basketballRoute,
  'andebol': handballRoute,
  'futebol': footballRoute,
  'hoquei-no-gelo': hockeyGlaceRoute,
  'hoquei-em-patins': rinkHockeyRoute,
  'hoquei-em-campo': hockeyGazonRoute,
  // SEO pages — FR/EN/ES/DE/DA
  ...
  // SEO pages — IT/PL/NL/PT slugs
  'tabellone-sportivo': tableauAffichageRoute,
  'tablica-wynikow-sportowa': tableauAffichageRoute,
  'sport-scorebord': tableauAffichageRoute,
  'placar-desportivo': tableauAffichageRoute,
  'tabellone-elettronico': tableauScoreRoute,
  'elektroniczna-tablica-wynikow': tableauScoreRoute,
  'elektronisch-scorebord': tableauScoreRoute,
  'placar-eletronico': tableauScoreRoute,
  'schermo-led-palestra': ecranLedRoute,
  'ekran-led-hala-sportowa': ecranLedRoute,
  'led-scherm-sporthal': ecranLedRoute,
  'tela-led-pavilhao': ecranLedRoute,
  'segnaletica-digitale-palasport': affichageDynamiqueRoute,
  'cyfrowe-oznakowanie-hala-sportowa': affichageDynamiqueRoute,
  'digitale-signage-sporthal': affichageDynamiqueRoute,
  'sinaletica-digital-pavilhao': affichageDynamiqueRoute,
  'punteggio-digitale': scoringDigitalRoute,
  'cyfrowe-punktowanie': scoringDigitalRoute,
  'pontuacao-digital': scoringDigitalRoute,
  'confronto-tabelloni-sportivi': comparatifRoute,
  'porownanie-tablic-sportowych': comparatifRoute,
  'vergelijking-sportscoreborden': comparatifRoute,
  'comparacao-placares-desportivos': comparatifRoute,
};
